package com.bank.bian.itstandardsandguidelines.model;
...
/**
 * The BIAN control record for this service domain: "IT Standard Directory Entry".
 *
 ...
 * to its asset type (IT Standard). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "IT Standard Directory Entry";
